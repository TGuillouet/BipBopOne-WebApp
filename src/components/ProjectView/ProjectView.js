...
import { faTrashAlt, faEye, faEyeSlash, faVectorSquare, faPaintRoller, faCube, faLink } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="card">
                    <div className="card-content">
                        <p className="subtitle">
                            Lien vers l'objet en AR à envoyer au client
                        </p>
                        <p className="content">
                            <a id="jesuislelien" href="http://localhost:9002/?asset=v1fdbRRxVEb9P78I8IAQ" target="_blank" rel="noopener noreferrer">http://localhost:9002/?asset=v1fdbRRxVEb9P78I8IAQ</a>
                        </p>
                    </div>
                </div>
            </Modal>
